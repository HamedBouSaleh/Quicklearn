    ...
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="flex justify-between items-center h-16 pr-4">
                    ...
                    <div class="flex items-center pl-8">
                        <Link href="/" class="flex items-center">
                            ...
                            <span class="ml-2 text-xl font-bold text-blue-600">QuickLearn</span>
                        </Link>
                    </div>
        ...
        <div class="flex relative">
            ...
            <button 
                ...
                class="fixed z-50 p-2 bg-gray-300 text-gray-700 hover:bg-gray-400 transition-all duration-300 rounded"
                style="top: 64px;"
            >
            ...
            <aside 
                :class="[
                    'fixed inset-y-0 left-0 z-40 w-64 bg-gray-100 border-r border-gray-300 shadow-lg transform transition-transform duration-300 ease-in-out',
            ...
            <!-- Main Content -->
            <main :class="sidebarOpen ? 'lg:ml-64' : 'ml-0'" class="flex-1 p-6 lg:p-8 transition-all duration-300">
                <slot />
            </main>
        </div>
