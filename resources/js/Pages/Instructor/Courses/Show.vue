                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 flex items-center space-x-4 text-sm text-gray-600">
                                            <span class="flex items-center">
                                                <svg v-if="['video','mixed'].includes((lesson.lesson_type || '').toLowerCase())" class="w-4 h-4 mr-1 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                </svg>
                                                <svg v-else class="w-4 h-4 mr-1 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 21v-8a2 2 0 00-2-2H7a2 2 0 00-2 2v8" />
                                                </svg>
                                                {{ lesson.lesson_type }}
                                            </span>
