            ...
            <div class="max-w-4xl mx-auto py-8 px-6">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 text-center">
                            <div class="text-4xl font-bold text-gray-900 mb-2">
                                {{ attempt.time_taken !== null ? attempt.time_taken : 'N/A' }}
                            </div>
                ...
                <div class="space-y-6 mb-8">
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            ...
                            <div v-if="!canRetake && !question.is_correct" class="bg-green-50 border border-green-200 rounded-lg p-4">
                            ...
                            <div v-if="canRetake && !question.is_correct" class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                <div class="text-sm text-yellow-800">
                                    <svg class="w-5 h-5 inline mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                                    </svg>
                                    Correct answer hidden - Use all your retakes to see corrections
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                    ...
                    <div v-else class="px-6 py-3 bg-gray-100 text-gray-500 font-semibold rounded-lg">
                        No More Retakes
                    </div>
                </div>
            </div>
